...
public class MobCoins extends JavaPlugin {
	...
	private final MobCoin mobCoin = new CoinManager(this);
	...
	public void onEnable() {
		...
		getServer().getServicesManager().register(MobCoin.class, mobCoin, this, ServicePriority.High);
	...
	public void generateFiles() {
		...
		// Attempts to sync the Configuration File content with what's required
		// by Default
		try {
		...
		// Attempts to sync the Data Storage File content with what's required
		// by Default
		try {
